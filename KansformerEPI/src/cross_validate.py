...
def get_args():
    ...
    p.add_argument('-o', "--outdir", default='../output', type=str, help="Output directory")
    p.add_argument('-c', "--config", default='/home/shshao/workplace/Trans-my/dev/config_500bp.json', type=str, help="model configuration")
